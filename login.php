...
<head>
	...
	<!-- Site favicon -->
	<link rel="apple-touch-icon" sizes="180x180" href="user/uploads/logo.jpg">
	<link rel="icon" type="image/png" sizes="32x32" href="user/uploads/logo.jpg">
	<link rel="icon" type="image/png" sizes="16x16" href="user/uploads/logo.jpg">
				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						...
						<form  action="action/main_work.php?option=login" method=post>
							<!-- <div class="select-role">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<label class="btn active">
										...
										<div class="icon"><img src="user/vendors/images/briefcase.svg" class="svg" alt=""></div>
										<span>I'm</span>
										Manager
									</label>
									<label class="btn">
										<input type="radio" name="options" id="user">
										<div class="icon"><img src="user/vendors/images/person.svg" class="svg" alt=""></div>
										<span>I'm</span>
										Employee
									</label>
								</div>
							...
							<div class="input-group custom">
								<input type="password" class="form-control form-control-lg" placeholder="**********" name=password value="<?php if (isset($_SESSION{'password'})) {echo $_SESSION['password'];}?>">
								<div class="input-group-append custom">
