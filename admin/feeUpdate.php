             ...
             <div class="midde_cont">
                  <div class="container-fluid">
                     <div class="row column_title">
                        ...
                        <div class="container">
                            <h2>Fee Update</h2><br>
                            <form action="../action/main_work.php?option=feeUpdate" method="post">
                            <input type="hidden" name="userid" value="<?php echo isset($id) ? $id : ''; ?>">


                            <div class="form-group">
                                <label for="loan">Fee</label>
                                <input type="text" id="loanAmountInput" name="fee" value="<?php echo $user->fee?>">
                            </div>
